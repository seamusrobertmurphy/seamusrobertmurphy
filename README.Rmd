...
![](README_files/figure-html/setup-2.png){style="float: right"; margin-right: 10em; height="25%" width="25%"}

```{r setup, include=T, echo=F, eval=F}

```

![](README_files/figure-html/setup-2.png)knitr::opts_chunk\$set(echo = TRUE) library('tweetrmd') #tweetrmd::tweet_embed("<https://x.com/SeamusRMurphy/status/1858588479288209551>") tweetrmd::tweet_screenshot( tweet_url("SeamusRMurphy", "1858588479288209551"), maxwidth = 400, hide_media = T, theme = "dark", scale = 1.5 ) \# \<img style="float: right"; src="README_files/figure-html/setup-1.png"\>
