...
easypackages::packages(  
  ...
  "kohonen", "knitr",
  "leafem", "libgeos","luz",
  "mapedit", "mapview", "maptiles", "markdown", "methods","mgcv", 
  "ncdf4", "nnet", 
  "openxlsx", 
  "parallel", "pandoc",
  "quarto",
